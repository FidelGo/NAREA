...
set.seed(123)
randomDataFrame <- generateRandomDataFrame(50)

# Define the processMarkdown function
processMarkdown <- function(py, px, r, d, I, counter) {
  # Read the markdown template
  template_path <- "/Users/SHSU/R_work/NAREA/SecondStep/PerfectSubs_MaxUt_Template_Food.Rmd"
...
exams2blackboard(exm, name="perfect_substitutes_maxut_food")
