...
$U=$ `r d` Nutella $+$ `r r` Ruffles

The price of Nutella is \$`r px`, the price of Ruffles is \$`r py`, and the income of the consumer is \$`r format(I, scientific=FALSE)`

What is the optimal amount of Ruffles that the consumer will purchase?
